...
export function LogoutIcon({ width = 18, height = 18, ...p }: IconProps) {
  return (
    <svg aria-hidden="true" width={width} height={height} viewBox="0 0 24 24" fill="none" {...p}>
      <path
...
export function WhatsAppIcon({ width = 28, height = 28 }: IconProps) {
  return (
    <svg aria-hidden="true" width={width} height={height} viewBox="0 0 32 32" fill="currentColor">
